...
print ("You got the loots, so organise  your belt alphabetically:")
belt.sort()
print("Your belt: ", belt)

# Lab04 - Q8 - Use the Belt
print("You see a Monster in the distance! Do, quickly use your first item!")
...
if first_item in good_loot_options:
    ...
    print(f"You used the {first_item}, but it was not enough")
...
print ("The Monster Combat Strength is n" + str(combat_strength) + "Using the " + power_roll + "magic")
#github.com/Tigran120
